                ...
                <div className="w-full h-[50vh]  flex items-center justify-center ">
                    <div className="w-[90%] h-[90%] bg-white flex">
                        <div className="w-[40%]  h-[100%] flex items-center justify-center ">
                            <div className="w-[35%]  h-[30%] flex  justify-between">
                                <div className="w-[2%] h-[100%] bg-[#21718E]"></div>
                                <div className="w-[90%] h-[100%]  flex items-center"><h1 className="text-[2vw] font-[600]">Our Vision</h1></div>
                            </div>
                        </div>
                        <div className="w-[60%] h-[100%] flex items-center justify-start ">
                            <div className="w-[45%] h-[80%] flex items-center justify-center ">
                                <h5 className="font-[700] text-[1vw] tracking-wide">At OptiManage, we envision a world where businesses, hotels, medical facilities and educational institutions operate efficiently, make data-driven decisions, and leverage the power of AI and ML to stay ahead in a rapidly evolving digital landscape.</h5></div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="w-full h-[95%] flex flex-col justify-evenly">
                                <div className="w-full h-[12%] ">
                                    <div className="w-full h-[20%]  flex">
                                        ...
                                        <div className="w-[95%] h-full ">
                                            <div className="w-[50%] h-full flex items-center "><h1 className="text-[1.5vw] font-[400]">Simplified Operations</h1></div>
                                        </div>
                                    </div>
                                ...
                                <div className="w-full h-[12%]  ">
                                    <div className="w-full h-[20%]  flex">
                                        ...
                                        <div className="w-[95%] h-full ">
                                            <div className="w-[50%] h-full flex items-center "><h1 className="text-[1.5vw] font-[400]">Tailored Solutions </h1></div>
                                        </div>
                                    </div>
                                ...
                                <div className="w-full h-[12%]  ">
                                    <div className="w-full h-[20%]  flex">
                                        ...
                                        <div className="w-[95%] h-full ">
                                            <div className="w-[50%] h-full flex items-center "><h1 className="text-[1.5vw] font-[400]">Enhanced Efficiency </h1></div>
                                        </div>
                                    </div>
                                ...
                                <div className="w-full h-[12%]  ">
                                    <div className="w-full h-[20%]  flex">
                                        ...
                                        <div className="w-[95%] h-full ">
                                            <div className="w-[50%] h-full flex items-center "><h1 className="text-[1.5vw] font-[400]">Reliable Support</h1></div>
                                        </div>
                                    </div>
                                ...
                                <div className="w-full h-[12%]  ">
                                    <div className="w-full h-[20%]  flex">
                                        ...
                                        <div className="w-[95%] h-full ">
                                            <div className="w-[50%] h-full flex items-center "><h1 className="text-[1.5vw] font-[400]">Scalability and Growth</h1></div>
                                        </div>
                                    </div>
